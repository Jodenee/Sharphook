...
namespace Sharphook.Models.Partials
{
	public class PartialWebhook
	{
		...
		public async Task<AbstractedResponce<ThreadMessage>> SendMessageInThread(UInt64 threadId, string? content = null, List<Embed>? embeds = null, bool waitForMessage = false, OptionalSendMessageInfo? optionalSendMessageInfo = null)
		{
		...
		public async Task<AbstractedResponce<EditedThreadMessage>> EditMessageInThread(UInt64 threadId, ulong messageId, string? content = null, List<Embed>? embeds = null)
		{
		...
		public async Task DeleteMessageInThread(UInt64 threadid, ulong messageId)
		{
			string requestUrl = $"{BaseUrl}/messages/{messageId}?thread_id={threadid}";
